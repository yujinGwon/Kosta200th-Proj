		...
		<div class="container">
			<div class="row">
				<div class="page-head-content">
					<h1 class="page-title">문의 게시판 글 작성하기</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="clearfix">
				<div class="wizard-container">
					...
					<div class="container">
 							<form action="./insert.do" method="post" name="frm">					      <div class="col-sm-10">
					        <label for="subject">이름</label>
					        <input type="text" class="form-control" name="d_u_name" placeholder="제목을 입력하세요.">
					      </div>
					      <div class="col-sm-10">
					        <label for="writer">비밀번호</label>
					        <input type="password" class="form-control" name="d_pass" placeholder="비밀번호를 입력하세요.">
					      </div>
					       <div class="col-sm-10">
					      ...
					      <div class="col-sm-10">
					        ...
					        <textarea class="form-control" name="d_content" rows="3"></textarea>
					      </div>
						  <br><br><br><br><br><br><br><br><br><br><br><br><br>
						  <div align="center">
      						<button type="submit" class="btn btn-primary" onclick="return dashboardCheck()">등록</button>
					      	<button type="button" onclick="location.href='javascript:history.go(-1)' " class="btn btn-primary">뒤로</button>

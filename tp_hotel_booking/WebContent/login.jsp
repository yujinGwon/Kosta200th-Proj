...
<script src="/tp_hotel_booking/js/idCheck.js"></script>
			...
			<div
				...
				<div class="box-for overflow">
					<div class="col-md-12 col-xs-12 login-blocks">
						...
						<div id="idCheck" name="idCheck" class="text-danger">
							<h5>&#8251 아이디 혹은 비밀번호를 확인해주세요.</h5>
						</div>

						<div class="text-center">
							<button name="login_button" id="login_button" type="button" class="btn btn-default">Log
								in</button>
						</div>
						<!-- </form> -->
						<br />

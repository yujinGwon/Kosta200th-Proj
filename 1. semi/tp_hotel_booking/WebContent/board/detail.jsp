		...
		<div class="container">
			<div class="row">
				<div class="page-head-content">
					<h1 class="page-title">문의 게시판 상세보기</h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="wizard-container">
					...
					<div class="container">
					      ...
					      <div class="col-sm-10">
					        ...
					        <input type="text" value="${vo.d_u_name }" class="form-control" id="name" name="d_u_name">
					      </div>
					      <div class="col-sm-10">
					        <label for="writer">제목</label>
					        <input type="text" value="${vo.d_title}" class="form-control" id="title" name="d_title">
					      </div>
					      <div class="col-sm-10">
					        <label for="content">내용</label>
					        <textarea class="form-control" id="content" name="d_content"  rows="3">${vo.d_content}</textarea>
					      </div>
					      <br><br><br><br><br><br><br><br><br><br>
					      <div align="center">
					      	<button type="button" class="btn btn-primary" onclick="location.href='./modifyView.do?num=${vo.d_no1 }' ">수정</button>
						  	<button type="button" class="btn btn-primary" onclick="location.href='./deleteView.do?num=${vo.d_no1 }' ">삭제</button>
